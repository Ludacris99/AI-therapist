        ...
        <div className="top-0 fixed w-screen z-200 border-b border-gray-100/30 bg-black/60 backdrop-blur-3xl">
            <header className="py-2 flex items-center justify-around max-sm:scale-80">
                    ...
                    <div className="flex items-center justify-center gap-14">
                        <Link href="/features" className="text-gray-400 hover:scale-110 hover:text-white transition-all max-sm:hidden">Features</Link>
                        <Link href="/signup"><button className="cursor-pointer w-30 bg-[#07C847]/70 px-5 py-3 rounded-2xl font-bold hover:scale-105 transition-all">Sign-Up</button></Link>
                    </div>
